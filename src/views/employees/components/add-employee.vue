    ...
    <el-form ref="form" label-width="120px" :model="formData" :rules="rules">
      ...
      <el-form-item label="部门" prop="departmentName">
        ...
        <el-cascader
          ...
          style="width:80%"
          :options="options"
          :props="{emitPath:false,label:'name',value:'name',checkStrictly:true}"
        />
      </el-form-item>
...
export default {
  ...
  data() {
    return {
      selectOptinons: EmployeeEnum.hireType,
      options: [],
      formData: {
        username: '', // 用户姓名
        mobile: '', // 手机号
